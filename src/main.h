...
static const int64 MAX_MONEY = 6000000000 * COIN; // TOS: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 1) / 250; // TOS: Priority cutoff is 2 TOS day / 250 bytes.
    }

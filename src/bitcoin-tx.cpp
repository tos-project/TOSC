...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("TOSC Core tosc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tosc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tosc transaction") + "\n" +
              "  tosc-tx [options] -create [commands]   " + _("Create hex-encoded tosc transaction") + "\n" +
              "\n";
